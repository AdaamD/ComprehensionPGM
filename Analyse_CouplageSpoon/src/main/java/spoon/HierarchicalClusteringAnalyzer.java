...
public class HierarchicalClusteringAnalyzer {
    ...
    //Initialise les clusters avec les classes du projet
    ...
    //Réalise une étape de clustering
    public boolean performNextClusteringStep() {
        ...
        // Affiche les clusters actuels et le couplage intra-cluster
    ...
    //Calcule le couplage intra-cluster d'un cluster
    ...
    //Trouve la paire de clusters la plus couplée
